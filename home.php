        ...
        <nav class="navbar navbar-expand-lg navbar-light header-bottom">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://www.facebook.com/trannhatduat/">Giới thiệu</a>
                    </li>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Xin Chào! Mình tên là Duật. Hiện tại mình đang theo học ngành <b>Công Nghệ Thông Tin </b> tại trường <b>Đại học thủy lợi</b></p>
